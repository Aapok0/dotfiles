...
key(
  ...
  { noremap = true, silent = true, desc = "Trouble: Buffer diagnostics" }
)
key(
  "n",
  "<leader>xs",
  "<cmd>Trouble symbols toggle focus=false<cr>",
  { noremap = true, silent = true, desc = "Trouble: Symbols" }
)
key(
  "n",
  "<leader>xl",
...
key(
  ...
  { noremap = true, silent = true, desc = "Trouble: Quickfix list" }
)
key(
  "n",
  "<leader>xL",
  "<cmd>Trouble lsp toggle focus=false win.position=right<cr>",
  { noremap = true, silent = true, desc = "Trouble: LSP references" }
)
